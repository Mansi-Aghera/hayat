...
const generatePrintContent = (data) => {
  return `
    ...
    <html>
      <head>
        <title>Expenditure Certificate – ${data.name}</title>
          ...
          <div class="certificate-card">
            ...
            <div class="mb-10">
              <div class="space-y-6 text-[16px] text-slate-800 leading-relaxed font-medium">
                <p>This is to certify that the above-named patient is under our treatment at this hospital.</p>
                
                <p>
                  The patient is suffering from 
                  <span class="font-black text-black uppercase">${data.suffering}</span>.
                </p>

                <p>
                  The estimated expenditure for the treatment/needs of the patient is 
                  <span class="font-black text-indigo-600 uppercase">${data.needs}</span>.
                </p>

                <p>This certificate is issued at the patient's request for financial assistance/official records.</p>

                <p class="font-black text-black pt-2 uppercase">Hence certified.</p>
              </div>
            </div>
...
export const handleExpenditurePrint = (data) => {
  if (!data) return;

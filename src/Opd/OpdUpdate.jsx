    ...
    <div className="max-w-7xl mx-auto pb-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-0"> {/* No extra padding on container, handled by internal components */}
          ...
          {/* Vitals Section */}
          <div className="py-3 border-b border-gray-50 bg-gray-50/30">
          ...
          {/* Medicine Section */}
          <div className="py-3 border-b border-gray-50 bg-blue-50/20">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-sm text-xs flex items-center gap-1.5"
                >
                  + Add Visit
                </button>
                <button

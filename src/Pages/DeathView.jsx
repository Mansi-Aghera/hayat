...
import { getDeath } from "../services/certificates.services";
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4 md:p-10 flex flex-col items-center">
      ...
      <div className="w-full max-w-[480px] mb-4 flex justify-between print:hidden">
        <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-slate-700 font-bold"><ArrowLeft size={18}/> Back</button>
        <button onClick={() => window.print()} className="bg-emerald-600 text-white px-5 py-2 rounded-full shadow hover:bg-emerald-700 flex items-center gap-2 font-bold"><Printer size={18}/> Print</button>
      </div>
      ...
      <div className="certificate-card w-full max-w-[480px] bg-white rounded-[32px] shadow-2xl p-10 font-sans print:shadow-none print:p-6 print:rounded-none">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-extrabold text-[#008080] border-b-4 border-[#008080] inline-block pb-1 tracking-wider uppercase">
            Death Certificate
          </h1>
        </div>
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-y-5">
            ...
            <div className="col-span-2">
              ...
              <p className="text-lg font-extrabold text-black">{data.address}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="text-xl font-bold text-[#008080] mb-4">Hospital Details</h2>
          <div className="space-y-6 text-[16px] text-slate-900 leading-relaxed font-medium">
            <p>
              ...
              <span className="font-extrabold text-black"> {data.admitted_datetime}</span>.
            </p>
            <p>
              The patient expired on 
              <span className="font-extrabold text-black"> {data.expired_datetime}</span>.
            </p>
            <p>
        ...
        <div className="text-right pt-8 border-slate-100">
